...
Мы предоставляем участникам возможность получить доступ к вычислительным ресурсам Christofari для обучения модели. Количество ресурсов ограничено. Для получения доступа необходимо отправить заявку на адрес Christofari_AIJContest_2023@sberbank.ru с описанием того, как именно планируется использовать вычислительные ресурсы. Отметим, что предоставленные участникам ресурсы могут быть использованы только для обучения моделей в рамках задачи Strong Intelligence.

Участникам, чьи заявки на обучение модели будут одобрены, необходимо предоставлять краткое описание прогресса по обучению модели каждые 2 недели с момента получения доступа к ресурсам. Отчет должен быть представлен в виде короткой презентации (1-2 слайда), которую необходимо отправлять на адрес Christofari_AIJContest_2023@sberbank.ru.
